...
public class JGalo extends JFrame implements ActionListener {
	...
	public static void main(String args[]) {
		// Criar um novo objeto JGalo, verificando se foi passado um argumento válido
		new JGalo(args.length == 0 ? new JGaloImp() : args[0].length() > 1 ? new JGaloImp() : new JGaloImp(args[0].charAt(0)));
	}
} 
